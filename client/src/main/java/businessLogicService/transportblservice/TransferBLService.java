...
public interface TransferBLService {
	 ...
	 */
	public double calFee(TransferReceiptVO vo) throws RemoteException, SQLException, MalformedURLException, NotBoundException, FileNotFoundException, ClassNotFoundException, IOException;
}
