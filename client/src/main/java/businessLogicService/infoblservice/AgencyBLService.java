...
public interface AgencyBLService {
     ...
     */
    public ArrayList<AgencyVO> getAgencyList() throws InfoBLException;
     ...
     * @throws InfoBLException, 表示RMI连接失败
     */
    public void addAgency(AgencyVO agencyItem) throws InfoBLException;

    /**
     * 界面层调用此方法请求在数据层中删除对应Info
     */
    public void deleteAgency(String id) throws InfoBLException;

    /**
     * 将type类型的编号为id的信息修改为传入的vo中的信息，如果修改失败则返回false，成功返回true
     */
    public void modifyAgency( String id, AgencyVO agencyItem) throws InfoBLException;
}
