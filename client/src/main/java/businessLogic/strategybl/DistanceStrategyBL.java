...
public class DistanceStrategyBL implements DistanceService{
	...
	public void initDistance() throws IOException, SQLException {
		...
		v2.add(new String("上海"));
		v2.add(new Double(1064.7));
		v2.add(new Double(0.0));
		v2.add(new Double(1213));
		v2.add(new Double(266));
		Vector<Object> v3=new Vector<Object>();
		v3.add(new String("广州"));
		v3.add(new Double(1888.8));
		v3.add(new Double(1213));
		v3.add(new Double(0));
		v3.add(new Double(1132));
		Vector<Object> v4=new Vector<Object>();
		v4.add(new String("南京"));
		v4.add(new Double(900));
		v4.add(new Double(266));
		v4.add(new Double(1132));
		v4.add(new Double(0));
		data.add(v1);
		data.add(v2);
		data.add(v3);
